...
if conductSineSweepExp==1
    %--------------------------
     ...
     AdditionalOmega=[0 0.001 0.01 0.1 0.5 12 15 18 125 150 175 250 500];
...
% theta_hat_array=theta_hat_array1;
    ...
    save('OpenLoop_SineSweep3.mat','g_hat_array','theta_hat_array')
